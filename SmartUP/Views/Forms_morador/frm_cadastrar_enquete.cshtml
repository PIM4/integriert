		...
		<div class="col s12 compensa">
				...
				<ul class="tab" style="margin-top: 0;">
					<li class="tab col s12 " style="background-color: #f6f6f6; padding: 10px 5px; border-radius: 10px;" >
						...
						<a class="" href="?<?php echo $login ?>&page=frm_buscar_area">
							<span class="span_forms">Buscar enquetes</span>
						</a>	
						/						
						<a class="span_forms ativo" href="#">
							<span class="span_forms">Cadastrar enquetes</span>
						</a>					
					</li>
				</ul>
			</div>
			<div class="row">
				<div class="col s12 " style="padding: 22px;">
					...
					<form class="">
						<h5 style="">Cadastro de enquetes</h5>
						<div class="row">
							<div class="input-field col s12 m3" >
								<input id="icon_prefix" type="text" class="validate">
								<label for="icon_prefix">Pergunta</label>
							</div>
							<div class="input-field col s12 m3" >
								<input id="icon_prefix" type="date" class="validate">
								<label for="icon_prefix">Data de inicio</label>
							</div>
							<div class="input-field col s12 m3" >
								<input id="icon_prefix" type="date" class="validate">
								<label for="icon_prefix">Data de encerramento</label>
							</div>
							<div class="input-field col s12 m3" >
								<input id="icon_prefix" type="number" class="validate">
								<label for="icon_prefix">Opções de voto</label>
							</div>
						</div>
						<div class="row">
							<div class="col s3">
