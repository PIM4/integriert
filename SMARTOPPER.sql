...
ALTER TABLE CONDOMINIO ADD ID_ENDERECO INT;

DELETE FROM CORRESPONDENCIA;
GO
ALTER TABLE CORRESPONDENCIA DROP COLUMN ID_PESSOA;
ALTER TABLE CORRESPONDENCIA ADD ID_PESSOA INT;

ALTER TABLE LOGIN DROP COLUMN EMAIL;
ALTER TABLE LOGIN ADD EMAIL VARCHAR(50) NOT NULL UNIQUE;