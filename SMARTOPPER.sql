...
ID_AREA_EVENTO INT PRIMARY KEY NOT NULL,
...
CREATE TABLE AVISO (
ID_AVISO INT PRIMARY KEY NOT NULL,
...
CREATE TABLE BLOCO (
ID_BLOCO INT PRIMARY KEY NOT NULL,
...
ID_COND INT PRIMARY KEY NOT NULL,
...
ID_CONTA_PAGAR INT PRIMARY KEY NOT NULL,
...
ID_CONTA_RECEBER INT PRIMARY KEY NOT NULL,
VALOR DECIMAL NOT NULL,
...
ID_CORRESPONDENCIA INT PRIMARY KEY NOT NULL,
DESCRICAO VARCHAR(50) NOT NULL,
...
ID_ENQUETE INT PRIMARY KEY NOT NULL,
...
ID_ENQUETE_ALTERNATIVAS INT PRIMARY KEY NOT NULL,
...
ID_MORADOR INT PRIMARY KEY NOT NULL,
ID_PESSOA INT NOT NULL,
ID_UNIDADE INT NOT NULL,
STS_ATIVO BIT NOT NULL
);
...
ID_RS INT PRIMARY KEY NOT NULL,
...
ID_TERCEIRO INT PRIMARY KEY NOT NULL,
...
ID_TERCEIRO_OBRA INT PRIMARY KEY NOT NULL,
...
ID_TIPO_OBRA INT PRIMARY KEY NOT NULL,
DESCRICAO VARCHAR(30) NOT NULL,
STS_ATIVO BIT NOT NULL
);
...
ID_TIPO_SERVICO INT PRIMARY KEY NOT NULL,
DESCRICAO VARCHAR(30) NOT NULL,
STS_ATIVO BIT NOT NULL
);
